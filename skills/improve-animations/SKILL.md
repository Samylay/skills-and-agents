...
- If the project (or your setup) has a per-app **animation plan** defining each app's *animation license*, meaning how much motion each surface earns (full / mid / minimal / out-of-scope), respect it: don't queue delight on a minimal-license or out-of-scope app.
