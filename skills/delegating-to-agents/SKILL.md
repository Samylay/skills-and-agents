...
- **Hermes** (Nous Research, Python): persistent autonomous agent with cross-session memory, a built-in scheduler, and 40+ tools; can orchestrate the other CLIs as workers. Skills: `~/.hermes/skills/`.
